  ...
  const toolSections = [
    {
      ...
      title: 'Your daily operation',
      tools: [
        ['Crew map', 'location-searching', 'CrewTracking', '#67E8F9'],
        ['Tasks', 'task-alt', 'Tasks', '#FDE68A'],
    ...
    ...(user?.role === 'boss' || user?.role === 'manager' ? [{
      ...
      title: 'People, access & operations',
      tools: [
        ['Crew clock', 'more-time', 'CrewClock', '#A7F3D0'],
        ['Kiosk', 'pin', 'Kiosk', '#FDBA74'],
        ['Team & roles', 'admin-panel-settings', 'Team', '#67E8F9'],
        ['Company', 'business', 'CompanySettings', '#A7F3D0'],
        ['Subscription', 'workspace-premium', 'Subscription', '#F9A8D4'],
      ],
    }] : []),
    {
      ...
      tools: [
        ['Profile', 'manage-accounts', 'Profile', '#A7F3D0'],
        ['Security', 'verified-user', 'Security', '#93C5FD'],
        ['Support', 'support-agent', 'Support', '#F9A8D4'],
        ['Contact', 'mail', 'Contact', '#FDE68A'],
        ['Privacy', 'privacy-tip', 'Privacy', '#C4B5FD'],
        ['Terms', 'description', 'Terms', '#FDBA74'],
        ['About', 'info', 'About', '#F9A8D4'],
      ],
    },
  ];
  ...
  return (
    <View style={investorStyles.screen}>
      ...
      >
        ...
        <View style={investorStyles.sectionHeader}><View><Text style={investorStyles.sectionEyebrow}>ALL TOOLS</Text><Text style={investorStyles.sectionTitle}>Everything in one place</Text></View></View>
        {toolSections.map(section => (
          <View key={section.eyebrow} style={investorStyles.toolSection}>
            <View style={investorStyles.toolSectionHeading}>
              <Text style={investorStyles.toolSectionEyebrow}>{section.eyebrow}</Text>
              <Text style={investorStyles.toolSectionTitle}>{section.title}</Text>
            </View>
...
const investorStyles = StyleSheet.create({
  ...
  toolSection: { marginBottom: 22 },
  toolSectionHeading: { marginBottom: 10, paddingLeft: 2 },
