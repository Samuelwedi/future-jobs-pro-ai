...
// ─── Preview Slip ──────────────────────────────────────────────────
export async function previewSlip(req: Request, res: Response) {
  try {
...
// ─── Finalize & Save Slip ──────────────────────────────────────────
export async function finalizeSlip(req: Request, res: Response) {
...
// ─── Get Employee Forms (what forms are available for an employee) ──
export async function getEmployeeForms(req: Request, res: Response) {
  try {
