...
-- ============================================================
-- 5. TRIGGER FOR AUTO-GENERATING INVOICE NUMBER (if not exists)
-- ============================================================
...
-- Trigger to update paid_amount on payment changes
...
async function run() {
  ...
  try {
    console.log('🔄 Running full migration on Railway...');
