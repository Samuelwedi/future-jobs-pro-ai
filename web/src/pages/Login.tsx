    ...
    <Box sx={{ bgcolor: '#0A0A0A', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <Container maxWidth="xs">
        <Paper sx={{ p: 4, bgcolor: '#1A1A1A', borderRadius: 3, border: '1px solid #333' }}>
          <Typography variant="h5" sx={{ color: '#FFF', fontWeight: 'bold', mb: 1, textAlign: 'center' }}>Sign In</Typography>
          <Typography variant="body2" sx={{ color: '#888', mb: 3, textAlign: 'center' }}>Welcome back to Future Jobs Pro AI</Typography>
          ...
          <Box sx={{ mt: 2, textAlign: 'center' }}>
            <Link href="/register" sx={{ color: '#00D4FF', fontSize: 14 }}>Don&apos;t have an account? Start free trial</Link>
          </Box>
        </Paper>
      </Container>
    </Box>
