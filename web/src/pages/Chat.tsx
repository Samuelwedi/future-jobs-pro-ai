...
import {
  ...
  CircularProgress, Avatar, Stack, Divider,
} from '@mui/material';
...
export default function ChatScreen() {
  ...
  const sendMessage = () => {
    ...
    socketRef.current.emit('chat-message', {
      senderId: 'current-user-id', // you need to get from localStorage or context
  ...
  const renderMessage = (msg: Message) => {
    const isMine = msg.sender_id === 'current-user-id'; // adjust
    return (
      <Box
        key={msg.id}
        sx={{
